...
import { Text, View, Dimensions, Modal, TouchableHighlight, Animated, ScrollView, Easing, LayoutChangeEvent, Appearance, StyleSheet } from 'react-native'
...
class ActionSheetWithInset extends React.Component {
    static defaultProps = {
    ...
    _createButton (title, index) {
        ...
        if(title === ""){
           return <View key={index} style={{height:8,width:'100%',backgroundColor:"#e5e5e5"}}></View>
        }
        return (
            <TouchableHighlight
                key={index}
            ...
            >
                <SafeAreaView style={[styles.wrapper]}>
                    ...
                    >
                        ...
                        {this.props.insets.bottom > 0 &&
                            <View style={[boxStyle, { height:this.props.insets.bottom , backgroundColor: darkMode ? "#2C2C2E" : "#fff" }]} />
                        }
                    </Animated.View>
                </SafeAreaView>
            </Modal>
...
const ActionSheet = withSafeAreaInsets(ActionSheetWithInset);
